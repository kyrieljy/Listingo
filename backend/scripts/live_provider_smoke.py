...
async def run(provider_code: str, reference_path: Path | None) -> None:
    ...
    with session_factory() as session:
        ...
        route = "edit" if provider.adapter == "openai_images_generation" and input_paths else "generate"
        print(
            json.dumps(
                {
...
if __name__ == "__main__":
    ...
    parser.add_argument("provider_code", choices=["yunwu-nano", "yunwu-image-2"])
